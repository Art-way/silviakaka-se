...
const Footer = () => (
    <footer className="flex flex-col items-center justify-center mt-16">
        ...
        <div className="font-sora w-full px-2 md:px-5 py-5 mt-12 md:mt-20
